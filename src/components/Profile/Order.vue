<template>
        <div class="app-order">
            ...
            <div class="Sel-Order">
                ...
                <div class="view-swiper">
                        <div class="nav-con">
                          <mt-navbar v-model="selected">
                            <mt-tab-item id="tab1">待付款</mt-tab-item>
                            <mt-tab-item id="tab2">全部订单</mt-tab-item>
                ...
                <!-- <div class="Order-list2">
                    <span class="order-item2 sel-one">代付款</span>
                    <span class="order-item2">未开组</span>
                    <span class="order-item2">全部订单</span>
                </div> -->
                <!-- 一对一订单为空的状态 -->
                <div class="noCart">
                    <!-- 代付款为空 -->
    ...
    <style scope>
       ...
       /* 订单列表 */
       .Order-list,.Order-list2{
           height:1rem;
           display: flex;
           justify-content: space-around;
           background:#fff;
       }
       .order-item,.order-item2{
           width:20%;
          text-align: center;
          line-height:1rem;
          font-size: 0.40rem;
